<x-tempates.public.head/>
12312312
<form class="max-w-screen-md mx-auto bg-amber-950 mt-10">
{{--
    <x-input-box-test name="form[email]"/>
--}}

    {{----}
    <x-input-box type="email" id="email" label="label test" name="form[email]" :user="$user" />
    <div class="relative input-box">
        <input type         = "email"
               ...
               class        = "
                    ...
                    rounded-lg border-1 border-gray-300
                    appearance-none
